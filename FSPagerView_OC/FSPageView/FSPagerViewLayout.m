...
- (nullable NSArray<__kindof UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    NSInteger numberOfItemsBefore = self.scrollDirection == FSPagerViewScrollDirectionHorizontal ? MAX((int)((CGRectGetMinX(rect1)-self.leadingSpacing)/self.itemSpacing),0) : MAX((int)((CGRectGetMinY(rect1)-self.leadingSpacing)/self.itemSpacing),0);
    ...
    CGFloat maxPosition = self.scrollDirection == FSPagerViewScrollDirectionHorizontal ? MIN(CGRectGetMaxX(rect1),self.contentSize.width-self.actualItemSize.width-self.leadingSpacing) : MIN(CGRectGetMaxY(rect1),self.contentSize.height-self.actualItemSize.height-self.leadingSpacing);
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    FSPagerViewLayoutAttributes *attributes = [FSPagerViewLayoutAttributes layoutAttributesForCellWithIndexPath:indexPath];
...
- (void)applyTransformToAttributes:(FSPagerViewLayoutAttributes *)attributes withTransformer:(FSPagerViewTransformer *)transformer {
    UICollectionView *collectionView = self.collectionView;
