...
#import "FSPagerViewCollectionView.h"

@interface FSPagerView() <UICollectionViewDelegate, UICollectionViewDataSource>

@property (nonatomic, strong) FSPagerViewLayout *collectionViewLayout;
@property (nonatomic, strong) FSPagerViewCollectionView *collectionView;
...
- (__kindof FSPagerViewCell *)dequeueReusableCellWithReuseIdentifier:(NSString *)identifier atIndex:(NSInteger)index {
    ...
    if (![cell isKindOfClass:[FSPagerViewCell class]]) {
        @throw [NSException exceptionWithName:@"" reason:@"Cell class must be subclass of FSPagerViewCell" userInfo:nil];
    }
...
- (void)commonInit {
    ...
    // UICollectionView
    FSPagerViewLayout *collectionViewLayout = [FSPagerViewLayout new];
    FSPagerViewCollectionView *collectionView = [[FSPagerViewCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:collectionViewLayout];
